...
LDLIBSOPTIONS=-lboost_system -lboost_filesystem
...
${OBJECTDIR}/src/MenuCtl.o: src/MenuCtl.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MenuCtl.o src/MenuCtl.cpp

${OBJECTDIR}/src/Position.o: src/Position.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Position.o src/Position.cpp
...
${OBJECTDIR}/src/autoCL.o: src/autoCL.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/autoCL.o src/autoCL.cpp
